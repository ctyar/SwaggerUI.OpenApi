...
public class SingleDocumentWithConfigTests : IClassFixture<WebApplicationFactory<SingleDocumentConfig.Program>>
{
    private readonly WebApplicationFactory<SingleDocumentConfig.Program> _factory;

    public SingleDocumentWithConfigTests(WebApplicationFactory<SingleDocumentConfig.Program> factory)
    {
        _factory = factory;
    }
